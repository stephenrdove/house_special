...
// Rule: compound phrases come before single keywords so "olive oil" beats "olive",
// "chicken broth" beats "chicken", "peanut butter" beats "butter", etc.
// "frozen" is always first so it overrides all other categories.
const KEYWORDS: [string, GroceryCategory][] = [
  // ── Frozen (always wins) ──────────────────────────────────────────────────
  ['frozen', 'Frozen'],

  // ── Cross-category compound phrases ──────────────────────────────────────
  // Must come before the single keywords they contain (e.g. "chicken broth"
  // before "chicken", "peanut butter" before "butter", "coconut milk" before "milk").

  // Canned compounds containing meat/dairy words
  ...
  // Condiment compounds containing produce/pantry/protein words
  ...
  // Canned compounds containing produce words
  ...
  // Pantry compounds containing produce/spice words
