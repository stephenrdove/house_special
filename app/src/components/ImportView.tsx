...
export function ImportView({ state, mutate, onImportSuccess }: Props) {
  ...
  function importData(data: { weeks: { week: number; days: { date: string; meal: string; notes?: string; leftover: boolean }[] }[]; grocery: { name: string; category: string; warn: boolean }[] }) {
